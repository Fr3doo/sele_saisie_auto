...
class WaiterProtocol(Protocol):
    def wait_for_dom_ready(self, driver: Any, timeout: int | None = None) -> None: ...
    def wait_until_dom_is_stable(self, driver: Any, timeout: int | None = None) -> bool: ...
    def wait_for_element(self, driver: Any, *args: Any, **kwargs: Any) -> Any: ...
    def find_clickable(self, driver: Any, *args: Any, **kwargs: Any) -> Any: ...
    def find_visible(self, driver: Any, *args: Any, **kwargs: Any) -> Any: ...
    def find_present(self, driver: Any, *args: Any, **kwargs: Any) -> Any: ...
...
class BrowserSessionProtocol(Protocol):
    ...
    def close(self) -> None: ...
    def wait_for_dom(self, driver: Any) -> None: ...
...
class DateEntryPageProtocol(Protocol):
    ...
    def process_date(self, driver: Any, date_cible: Any) -> bool | None: ...
...
class AdditionalInfoPageProtocol(Protocol):
    ...
    def save_draft_and_validate(self, driver: Any) -> None: ...
